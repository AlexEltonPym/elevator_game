...
corridor, on to D.",
	...
	# ===================== GENERIC =====================
	{
		...
		"rooms": [
			{"type": "store", "cells": [Vector2i(0, 0), Vector2i(1, 0)],
					"drops": [{"cell": Vector2i(1, 0), "dir": R}]},
			{"type": "cafe", "cells": [Vector2i(5, 5), Vector2i(6, 5)],
					"drops": [{"cell": Vector2i(5, 5), "dir": L}]},
			{"type": "store", "cells": [Vector2i(0, 1), Vector2i(1, 1)],
					"drops": [{"cell": Vector2i(1, 1), "dir": R}]},
			{"type": "cafe", "cells": [Vector2i(5, 6), Vector2i(6, 6)],
					"drops": [{"cell": Vector2i(5, 6), "dir": L}]},
			{"type": "store", "cells": [Vector2i(0, 2), Vector2i(1, 2)],
					"drops": [{"cell": Vector2i(1, 2), "dir": R}]},
			{"type": "cafe", "cells": [Vector2i(5, 7), Vector2i(6, 7)],
					"drops": [{"cell": Vector2i(5, 7), "dir": L}]},
			{"type": "store", "cells": [Vector2i(0, 3), Vector2i(1, 3)],
					"drops": [{"cell": Vector2i(1, 3), "dir": R}]},
			{"type": "cafe", "cells": [Vector2i(5, 8), Vector2i(6, 8)],
					"drops": [{"cell": Vector2i(5, 8), "dir": L}]},
			{"type": "store", "cells": [Vector2i(0, 4), Vector2i(1, 4)],
					"drops": [{"cell": Vector2i(1, 4), "dir": R}]},
			{"type": "cafe", "cells": [Vector2i(5, 9), Vector2i(6, 9)],

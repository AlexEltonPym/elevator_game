...
corridor, on to D.",
	...
	{
		"id": "XL2", "world": "CROSSLINK", "name": "Warmup", "thesis": "", "intro": "",
		"cols": 9, "rows": 9, "blocked": [],
		"overlaps": [
			{"cells": [Vector2i(0, 0), Vector2i(0, 1), Vector2i(0, 2), Vector2i(0, 3), Vector2i(0, 4), Vector2i(0, 5), Vector2i(0, 6), Vector2i(0, 7), Vector2i(0, 8), Vector2i(1, 0), Vector2i(1, 1), Vector2i(1, 2), Vector2i(1, 4), Vector2i(1, 5), Vector2i(1, 6), Vector2i(1, 7), Vector2i(1, 8), Vector2i(2, 2), Vector2i(2, 5), Vector2i(2, 6), Vector2i(2, 7), Vector2i(2, 8), Vector2i(3, 2), Vector2i(3, 5), Vector2i(3, 6), Vector2i(3, 7), Vector2i(3, 8), Vector2i(4, 2), Vector2i(4, 4), Vector2i(4, 7), Vector2i(4, 8), Vector2i(5, 1), Vector2i(5, 2), Vector2i(5, 4), Vector2i(5, 7), Vector2i(5, 8), Vector2i(6, 0), Vector2i(6, 1), Vector2i(6, 2), Vector2i(6, 4), Vector2i(6, 7), Vector2i(6, 8), Vector2i(7, 0), Vector2i(7, 1), Vector2i(7, 2), Vector2i(7, 4), Vector2i(7, 7), Vector2i(7, 8), Vector2i(8, 0), Vector2i(8, 1), Vector2i(8, 2), Vector2i(8, 4), Vector2i(8, 5), Vector2i(8, 6), Vector2i(8, 7), Vector2i(8, 8)], "max": 3},
			{"cells": [Vector2i(5, 0), Vector2i(7, 5), Vector2i(4, 5), Vector2i(5, 3), Vector2i(6, 3)], "max": 6},
		],
		"rooms": [
			{"type": "lobby", "cells": [Vector2i(2, 0), Vector2i(3, 0), Vector2i(4, 0), Vector2i(2, 1), Vector2i(3, 1), Vector2i(4, 1)], "drops": [{"cell": Vector2i(4, 0), "dir": R}]},
			{"type": "cafe", "cells": [Vector2i(7, 6), Vector2i(6, 6), Vector2i(5, 6), Vector2i(4, 6), Vector2i(6, 5), Vector2i(5, 5)], "drops": [{"cell": Vector2i(6, 5), "dir": R}, {"cell": Vector2i(5, 5), "dir": L}]},
			{"type": "penthouse", "cells": [Vector2i(1, 3), Vector2i(2, 3), Vector2i(3, 3), Vector2i(4, 3), Vector2i(2, 4), Vector2i(3, 4)], "drops": [{"cell": Vector2i(4, 3), "dir": R}]},
			{"type": "apartment", "cells": [Vector2i(8, 3), Vector2i(7, 3)], "drops": [{"cell": Vector2i(7, 3), "dir": L}]},
		],
		"cards": [
			{"name": "LOCAL", "type": "standard", "color": COL_A},
			{"name": "EXPRESS", "type": "express", "color": COL_D, "speed": 1500.0, "accel": 1200.0},
	...
	{
		"id": "XL3", "world": "CROSSLINK", "name": "Sidestep", "thesis": "", "intro": "",
		"cols": 9, "rows": 9, "blocked": [],
		"overlaps": [
			{"cells": [Vector2i(0, 0), Vector2i(0, 1), Vector2i(0, 2), Vector2i(0, 3), Vector2i(0, 5), Vector2i(0, 6), Vector2i(0, 7), Vector2i(0, 8), Vector2i(1, 0), Vector2i(1, 1), Vector2i(1, 2), Vector2i(1, 3), Vector2i(1, 5), Vector2i(1, 6), Vector2i(1, 7), Vector2i(1, 8), Vector2i(2, 0), Vector2i(2, 1), Vector2i(2, 2), Vector2i(2, 3), Vector2i(2, 5), Vector2i(2, 6), Vector2i(2, 8), Vector2i(3, 0), Vector2i(3, 1), Vector2i(3, 2), Vector2i(3, 3), Vector2i(3, 4), Vector2i(3, 5), Vector2i(3, 6), Vector2i(4, 1), Vector2i(4, 2), Vector2i(4, 3), Vector2i(4, 6), Vector2i(5, 2), Vector2i(5, 3), Vector2i(5, 6), Vector2i(5, 8), Vector2i(6, 2), Vector2i(6, 3), Vector2i(6, 6), Vector2i(6, 8), Vector2i(7, 2), Vector2i(7, 3), Vector2i(7, 6), Vector2i(7, 7), Vector2i(7, 8), Vector2i(8, 0), Vector2i(8, 1), Vector2i(8, 2), Vector2i(8, 3), Vector2i(8, 4), Vector2i(8, 5), Vector2i(8, 6), Vector2i(8, 7), Vector2i(8, 8)], "max": 3},
			{"cells": [Vector2i(4, 0), Vector2i(7, 4), Vector2i(4, 4), Vector2i(6, 7), Vector2i(2, 4)], "max": 6},
		],
		"rooms": [
			...
			{"type": "cafe", "cells": [Vector2i(7, 5), Vector2i(6, 5), Vector2i(5, 5), Vector2i(4, 5), Vector2i(6, 4), Vector2i(5, 4)], "drops": [{"cell": Vector2i(6, 4), "dir": R}, {"cell": Vector2i(5, 4), "dir": L}]},
	...
	{
		"id": "XL4", "world": "CROSSLINK", "name": "Rush Hour", "thesis": "", "intro": "",
		"cols": 9, "rows": 9, "blocked": [],
		"overlaps": [
			{"cells": [Vector2i(0, 0), Vector2i(0, 1), Vector2i(0, 2), Vector2i(0, 3), Vector2i(0, 4), Vector2i(0, 5), Vector2i(0, 6), Vector2i(0, 7), Vector2i(0, 8), Vector2i(1, 0), Vector2i(1, 1), Vector2i(1, 2), Vector2i(1, 3), Vector2i(1, 4), Vector2i(1, 7), Vector2i(1, 8), Vector2i(2, 0), Vector2i(2, 1), Vector2i(2, 3), Vector2i(2, 4), Vector2i(2, 7), Vector2i(2, 8), Vector2i(3, 0), Vector2i(3, 1), Vector2i(3, 4), Vector2i(3, 7), Vector2i(3, 8), Vector2i(4, 1), Vector2i(4, 4), Vector2i(4, 8), Vector2i(5, 2), Vector2i(5, 3), Vector2i(5, 4), Vector2i(5, 5), Vector2i(5, 6), Vector2i(6, 3), Vector2i(6, 4), Vector2i(6, 5), Vector2i(6, 6), Vector2i(7, 3), Vector2i(7, 4), Vector2i(7, 5), Vector2i(7, 6), Vector2i(7, 8), Vector2i(8, 0), Vector2i(8, 1), Vector2i(8, 3), Vector2i(8, 4), Vector2i(8, 5), Vector2i(8, 6), Vector2i(8, 8)], "max": 3},
			{"cells": [Vector2i(4, 0), Vector2i(1, 5), Vector2i(4, 5), Vector2i(8, 7), Vector2i(2, 2), Vector2i(8, 2)], "max": 6},
		],
		"rooms": [
			{"type": "lobby", "cells": [Vector2i(7, 0), Vector2i(6, 0), Vector2i(5, 0), Vector2i(7, 1), Vector2i(6, 1), Vector2i(5, 1)], "drops": [{"cell": Vector2i(5, 0), "dir": L}]},
			...
			{"type": "penthouse", "cells": [Vector2i(4, 7), Vector2i(5, 7), Vector2i(6, 7), Vector2i(7, 7), Vector2i(5, 8), Vector2i(6, 8)], "drops": [{"cell": Vector2i(7, 7), "dir": R}]},
			{"type": "delivery", "label": "storage", "cells": [Vector2i(4, 2), Vector2i(3, 2), Vector2i(4, 3), Vector2i(3, 3)], "drops": [{"cell": Vector2i(3, 2), "dir": L}]},
			{"type": "apartment", "cells": [Vector2i(6, 2), Vector2i(7, 2)], "drops": [{"cell": Vector2i(7, 2), "dir": R}]},
		],
		"cards": [
			{"name": "LOCAL", "type": "standard", "color": COL_A},
			{"name": "EXPRESS", "type": "express", "color": COL_D, "speed": 1500.0, "accel": 1200.0},
		...
		"trips": [
			...
			{"w": 0.10, "from": "A", "to": "E"},
			{"w": 0.06, "from": "E", "to": "A"},
			{"w": 0.14, "from": "D", "to": "B", "type": "delivery"},
			{"w": 0.06, "from": "B", "to": "D", "type": "delivery"},
		],
	},
	{
		"id": "XL5", "world": "CROSSLINK", "name": "Gridlock", "thesis": "", "intro": "",
		"cols": 9, "rows": 10, "blocked": [],
		"overlaps": [
			{"cells": [Vector2i(0, 0), Vector2i(0, 1), Vector2i(0, 2), Vector2i(0, 4), Vector2i(0, 5), Vector2i(0, 8), Vector2i(0, 9), Vector2i(1, 0), Vector2i(1, 1), Vector2i(1, 2), Vector2i(1, 5), Vector2i(1, 8), Vector2i(1, 9), Vector2i(2, 1), Vector2i(2, 2), Vector2i(2, 5), Vector2i(2, 8), Vector2i(2, 9), Vector2i(3, 2), Vector2i(3, 4), Vector2i(3, 5), Vector2i(3, 8), Vector2i(3, 9), Vector2i(4, 2), Vector2i(4, 4), Vector2i(4, 5), Vector2i(4, 6), Vector2i(4, 7), Vector2i(4, 8), Vector2i(4, 9), Vector2i(5, 2), Vector2i(5, 3), Vector2i(5, 4), Vector2i(5, 5), Vector2i(5, 6), Vector2i(5, 7), Vector2i(5, 9), Vector2i(6, 3), Vector2i(6, 4), Vector2i(6, 5), Vector2i(6, 6), Vector2i(6, 7), Vector2i(6, 9), Vector2i(7, 3), Vector2i(7, 4), Vector2i(7, 5), Vector2i(7, 6), Vector2i(7, 7), Vector2i(7, 9), Vector2i(8, 2), Vector2i(8, 3), Vector2i(8, 4), Vector2i(8, 5), Vector2i(8, 6), Vector2i(8, 7), Vector2i(8, 8), Vector2i(8, 9)], "max": 3},
			{"cells": [Vector2i(2, 0), Vector2i(0, 6), Vector2i(3, 6), Vector2i(4, 3), Vector2i(8, 1), Vector2i(5, 8), Vector2i(8, 0)], "max": 6},
		],
		"rooms": [
			{"type": "lobby", "cells": [Vector2i(5, 0), Vector2i(4, 0), Vector2i(3, 0), Vector2i(5, 1), Vector2i(4, 1), Vector2i(3, 1)], "drops": [{"cell": Vector2i(3, 0), "dir": L}]},
			{"type": "cafe", "cells": [Vector2i(0, 7), Vector2i(1, 7), Vector2i(2, 7), Vector2i(3, 7), Vector2i(1, 6), Vector2i(2, 6)], "drops": [{"cell": Vector2i(1, 6), "dir": L}, {"cell": Vector2i(2, 6), "dir": R}]},
			{"type": "penthouse", "cells": [Vector2i(0, 3), Vector2i(1, 3), Vector2i(2, 3), Vector2i(3, 3), Vector2i(1, 4), Vector2i(2, 4)], "drops": [{"cell": Vector2i(3, 3), "dir": R}]},
			{"type": "delivery", "label": "storage", "cells": [Vector2i(6, 1), Vector2i(7, 1), Vector2i(6, 2), Vector2i(7, 2)], "drops": [{"cell": Vector2i(7, 1), "dir": R}]},
			{"type": "apartment", "cells": [Vector2i(7, 8), Vector2i(6, 8)], "drops": [{"cell": Vector2i(6, 8), "dir": L}]},
			{"type": "apartment", "cells": [Vector2i(6, 0), Vector2i(7, 0)], "drops": [{"cell": Vector2i(7, 0), "dir": R}]},
		],
		"cards": [
			{"name": "LOCAL", "type": "standard", "color": COL_A},
			{"name": "EXPRESS", "type": "express", "color": COL_D, "speed": 1500.0, "accel": 1200.0},
	...
	{
		"id": "XL6", "world": "CROSSLINK", "name": "Long Haul", "thesis": "", "intro": "",
		"cols": 9, "rows": 9, "blocked": [],
		"overlaps": [
			{"cells": [Vector2i(0, 0), Vector2i(0, 1), Vector2i(0, 4), Vector2i(0, 7), Vector2i(0, 8), Vector2i(1, 0), Vector2i(1, 1), Vector2i(1, 4), Vector2i(1, 7), Vector2i(1, 8), Vector2i(2, 0), Vector2i(2, 1), Vector2i(2, 4), Vector2i(2, 6), Vector2i(2, 7), Vector2i(2, 8), Vector2i(3, 2), Vector2i(3, 4), Vector2i(3, 5), Vector2i(3, 6), Vector2i(3, 7), Vector2i(3, 8), Vector2i(4, 2), Vector2i(4, 5), Vector2i(4, 8), Vector2i(5, 2), Vector2i(5, 5), Vector2i(5, 8), Vector2i(6, 1), Vector2i(6, 2), Vector2i(6, 4), Vector2i(6, 5), Vector2i(7, 0), Vector2i(7, 1), Vector2i(7, 2), Vector2i(7, 4), Vector2i(7, 5), Vector2i(8, 0), Vector2i(8, 1), Vector2i(8, 2), Vector2i(8, 3), Vector2i(8, 4), Vector2i(8, 5), Vector2i(8, 6), Vector2i(8, 7)], "max": 3},
			{"cells": [Vector2i(6, 0), Vector2i(4, 6), Vector2i(7, 6), Vector2i(7, 3), Vector2i(2, 5), Vector2i(8, 8), Vector2i(2, 3), Vector2i(2, 2)], "max": 6},
		],
		"rooms": [
			...
			{"type": "cafe", "cells": [Vector2i(4, 7), Vector2i(5, 7), Vector2i(6, 7), Vector2i(7, 7), Vector2i(5, 6), Vector2i(6, 6)], "drops": [{"cell": Vector2i(5, 6), "dir": L}, {"cell": Vector2i(6, 6), "dir": R}]},
			{"type": "penthouse", "cells": [Vector2i(3, 3), Vector2i(4, 3), Vector2i(5, 3), Vector2i(6, 3), Vector2i(4, 4), Vector2i(5, 4)], "drops": [{"cell": Vector2i(6, 3), "dir": R}]},
			{"type": "delivery", "label": "storage", "cells": [Vector2i(0, 5), Vector2i(1, 5), Vector2i(0, 6), Vector2i(1, 6)], "drops": [{"cell": Vector2i(1, 5), "dir": R}]},
			{"type": "apartment", "cells": [Vector2i(6, 8), Vector2i(7, 8)], "drops": [{"cell": Vector2i(7, 8), "dir": R}]},
			{"type": "apartment", "cells": [Vector2i(0, 3), Vector2i(1, 3)], "drops": [{"cell": Vector2i(1, 3), "dir": R}]},
			{"type": "apartment", "cells": [Vector2i(0, 2), Vector2i(1, 2)], "drops": [{"cell": Vector2i(1, 2), "dir": R}]},
		],
		"cards": [
			{"name": "LOCAL", "type": "standard", "color": COL_A},
			{"name": "EXPRESS", "type": "express", "color": COL_D, "speed": 1500.0, "accel": 1200.0},
	...
	{
		"id": "XL7", "world": "CROSSLINK", "name": "Foyer", "thesis": "", "intro": "",
		"cols": 9, "rows": 9, "blocked": [],
		"overlaps": [
			{"cells": [Vector2i(0, 0), Vector2i(0, 1), Vector2i(0, 2), Vector2i(0, 3), Vector2i(0, 4), Vector2i(0, 5), Vector2i(0, 6), Vector2i(0, 7), Vector2i(0, 8), Vector2i(1, 0), Vector2i(1, 2), Vector2i(1, 3), Vector2i(1, 4), Vector2i(1, 5), Vector2i(1, 6), Vector2i(1, 7), Vector2i(1, 8), Vector2i(2, 0), Vector2i(2, 2), Vector2i(2, 3), Vector2i(2, 4), Vector2i(2, 5), Vector2i(2, 6), Vector2i(2, 7), Vector2i(2, 8), Vector2i(3, 0), Vector2i(3, 2), Vector2i(3, 3), Vector2i(3, 4), Vector2i(3, 5), Vector2i(3, 6), Vector2i(3, 7), Vector2i(3, 8), Vector2i(4, 2), Vector2i(4, 3), Vector2i(4, 4), Vector2i(4, 6), Vector2i(5, 2), Vector2i(5, 3), Vector2i(5, 4), Vector2i(6, 2), Vector2i(6, 3), Vector2i(6, 4), Vector2i(7, 1), Vector2i(7, 2), Vector2i(7, 3), Vector2i(7, 4), Vector2i(7, 6), Vector2i(8, 0), Vector2i(8, 1), Vector2i(8, 2), Vector2i(8, 3), Vector2i(8, 4), Vector2i(8, 6), Vector2i(8, 7), Vector2i(8, 8)], "max": 3},
			{"cells": [Vector2i(7, 0), Vector2i(4, 7), Vector2i(7, 7), Vector2i(8, 5), Vector2i(3, 1)], "max": 6},
		],
		"rooms": [
			...
			{"type": "penthouse", "cells": [Vector2i(4, 5), Vector2i(5, 5), Vector2i(6, 5), Vector2i(7, 5), Vector2i(5, 6), Vector2i(6, 6)], "drops": [{"cell": Vector2i(7, 5), "dir": R}]},
	...
	{
		"id": "XL8", "world": "CROSSLINK", "name": "Skylight", "thesis": "", "intro": "",
		"cols": 9, "rows": 11, "blocked": [Vector2i(6, 2)],
		"overlaps": [
			{"cells": [Vector2i(0, 0), Vector2i(0, 1), Vector2i(0, 2), Vector2i(0, 3), Vector2i(0, 4), Vector2i(0, 5), Vector2i(0, 6), Vector2i(0, 7), Vector2i(0, 9), Vector2i(0, 10), Vector2i(1, 2), Vector2i(1, 4), Vector2i(1, 6), Vector2i(1, 7), Vector2i(1, 9), Vector2i(1, 10), Vector2i(2, 2), Vector2i(2, 6), Vector2i(2, 7), Vector2i(2, 10), Vector2i(3, 2), Vector2i(3, 6), Vector2i(3, 7), Vector2i(3, 8), Vector2i(3, 10), Vector2i(4, 1), Vector2i(4, 2), Vector2i(4, 4), Vector2i(4, 5), Vector2i(4, 6), Vector2i(4, 7), Vector2i(4, 10), Vector2i(5, 0), Vector2i(5, 1), Vector2i(5, 2), Vector2i(5, 4), Vector2i(5, 5), Vector2i(5, 6), Vector2i(5, 7), Vector2i(5, 10), Vector2i(6, 0), Vector2i(6, 1), Vector2i(6, 3), Vector2i(6, 4), Vector2i(6, 5), Vector2i(6, 6), Vector2i(6, 7), Vector2i(6, 10), Vector2i(7, 0), Vector2i(7, 1), Vector2i(7, 2), Vector2i(7, 3), Vector2i(7, 4), Vector2i(7, 5), Vector2i(7, 6), Vector2i(7, 7), Vector2i(7, 8), Vector2i(7, 9), Vector2i(7, 10), Vector2i(8, 0), Vector2i(8, 1), Vector2i(8, 2), Vector2i(8, 3), Vector2i(8, 4), Vector2i(8, 5), Vector2i(8, 6), Vector2i(8, 7), Vector2i(8, 8), Vector2i(8, 9), Vector2i(8, 10)], "max": 3},
			{"cells": [Vector2i(4, 0), Vector2i(2, 9), Vector2i(6, 9), Vector2i(5, 3), Vector2i(1, 5), Vector2i(2, 8), Vector2i(6, 8)], "max": 6},
		],
		"rooms": [
			...
			{"type": "penthouse", "cells": [Vector2i(1, 3), Vector2i(2, 3), Vector2i(3, 3), Vector2i(4, 3), Vector2i(2, 4), Vector2i(3, 4)], "drops": [{"cell": Vector2i(4, 3), "dir": R}]},
			{"type": "apartment", "cells": [Vector2i(3, 5), Vector2i(2, 5)], "drops": [{"cell": Vector2i(2, 5), "dir": L}]},
			{"type": "apartment", "cells": [Vector2i(0, 8), Vector2i(1, 8)], "drops": [{"cell": Vector2i(1, 8), "dir": R}]},
			{"type": "apartment", "cells": [Vector2i(4, 8), Vector2i(5, 8)], "drops": [{"cell": Vector2i(5, 8), "dir": R}]},
		],
		"cards": [
			{"name": "LOCAL", "type": "standard", "color": COL_A},
			{"name": "EXPRESS", "type": "express", "color": COL_D, "speed": 1500.0, "accel": 1200.0},
	...
	{
		"id": "XL9", "world": "CROSSLINK", "name": "Freight Only", "thesis": "", "intro": "",
		"cols": 9, "rows": 11, "blocked": [Vector2i(2, 6)],
		"overlaps": [
			{"cells": [Vector2i(0, 0), Vector2i(0, 1), Vector2i(0, 2), Vector2i(0, 3), Vector2i(0, 4), Vector2i(0, 5), Vector2i(0, 6), Vector2i(0, 7), Vector2i(0, 9), Vector2i(0, 10), Vector2i(1, 2), Vector2i(1, 3), Vector2i(1, 4), Vector2i(1, 5), Vector2i(1, 6), Vector2i(1, 7), Vector2i(1, 9), Vector2i(1, 10), Vector2i(2, 2), Vector2i(2, 3), Vector2i(2, 4), Vector2i(2, 5), Vector2i(2, 7), Vector2i(2, 9), Vector2i(2, 10), Vector2i(3, 2), Vector2i(3, 3), Vector2i(3, 4), Vector2i(3, 5), Vector2i(3, 6), Vector2i(3, 7), Vector2i(3, 8), Vector2i(4, 1), Vector2i(4, 2), Vector2i(4, 3), Vector2i(4, 4), Vector2i(4, 5), Vector2i(5, 0), Vector2i(5, 1), Vector2i(5, 2), Vector2i(5, 3), Vector2i(5, 4), Vector2i(5, 5), Vector2i(6, 0), Vector2i(6, 1), Vector2i(6, 2), Vector2i(6, 3), Vector2i(6, 4), Vector2i(6, 5), Vector2i(6, 7), Vector2i(7, 0), Vector2i(7, 1), Vector2i(7, 2), Vector2i(7, 3), Vector2i(7, 4), Vector2i(7, 5), Vector2i(7, 6), Vector2i(7, 7), Vector2i(7, 8), Vector2i(7, 9), Vector2i(7, 10), Vector2i(8, 0), Vector2i(8, 1), Vector2i(8, 2), Vector2i(8, 3), Vector2i(8, 4), Vector2i(8, 5), Vector2i(8, 6), Vector2i(8, 7), Vector2i(8, 8), Vector2i(8, 9), Vector2i(8, 10)], "max": 3},
			{"cells": [Vector2i(4, 0), Vector2i(3, 9), Vector2i(6, 9), Vector2i(6, 6), Vector2i(2, 8), Vector2i(6, 8)], "max": 6},
		],
		"rooms": [
			{"type": "lobby", "cells": [Vector2i(1, 0), Vector2i(2, 0), Vector2i(3, 0), Vector2i(1, 1), Vector2i(2, 1), Vector2i(3, 1)], "drops": [{"cell": Vector2i(3, 0), "dir": R}]},
			...
			{"type": "delivery", "label": "storage", "cells": [Vector2i(4, 6), Vector2i(5, 6), Vector2i(4, 7), Vector2i(5, 7)], "drops": [{"cell": Vector2i(5, 6), "dir": R}]},
			{"type": "apartment", "cells": [Vector2i(0, 8), Vector2i(1, 8)], "drops": [{"cell": Vector2i(1, 8), "dir": R}]},
			{"type": "apartment", "cells": [Vector2i(4, 8), Vector2i(5, 8)], "drops": [{"cell": Vector2i(5, 8), "dir": R}]},
		],
		"cards": [
		...
		"trips": [
			...
			{"w": 0.10, "from": "A", "to": "E"},
			{"w": 0.06, "from": "E", "to": "A"},
			{"w": 0.14, "from": "C", "to": "B", "type": "delivery"},
			{"w": 0.06, "from": "B", "to": "C", "type": "delivery"},
		],
	},
	{
		"id": "XL10", "world": "CROSSLINK", "name": "Full House", "thesis": "", "intro": "",
		"cols": 9, "rows": 10, "blocked": [],
		"overlaps": [
			{"cells": [Vector2i(0, 2), Vector2i(0, 3), Vector2i(0, 4), Vector2i(0, 5), Vector2i(0, 8), Vector2i(0, 9), Vector2i(1, 2), Vector2i(1, 3), Vector2i(1, 4), Vector2i(1, 5), Vector2i(1, 8), Vector2i(1, 9), Vector2i(2, 2), Vector2i(2, 4), Vector2i(2, 5), Vector2i(2, 9), Vector2i(3, 1), Vector2i(3, 2), Vector2i(3, 4), Vector2i(3, 5), Vector2i(3, 9), Vector2i(4, 2), Vector2i(4, 4), Vector2i(4, 6), Vector2i(4, 7), Vector2i(4, 9), Vector2i(5, 2), Vector2i(5, 4), Vector2i(5, 7), Vector2i(5, 8), Vector2i(5, 9), Vector2i(6, 1), Vector2i(6, 2), Vector2i(6, 4), Vector2i(6, 7), Vector2i(6, 8), Vector2i(6, 9), Vector2i(7, 0), Vector2i(7, 1), Vector2i(7, 2), Vector2i(7, 3), Vector2i(7, 4), Vector2i(7, 6), Vector2i(7, 7), Vector2i(7, 8), Vector2i(7, 9), Vector2i(8, 0), Vector2i(8, 1), Vector2i(8, 2), Vector2i(8, 3), Vector2i(8, 4), Vector2i(8, 6), Vector2i(8, 7), Vector2i(8, 8), Vector2i(8, 9)], "max": 3},
			{"cells": [Vector2i(3, 0), Vector2i(0, 6), Vector2i(3, 6), Vector2i(8, 5), Vector2i(6, 0), Vector2i(4, 8), Vector2i(2, 3), Vector2i(6, 3)], "max": 6},
		],
		"rooms": [
			...
			{"type": "cafe", "cells": [Vector2i(0, 7), Vector2i(1, 7), Vector2i(2, 7), Vector2i(3, 7), Vector2i(1, 6), Vector2i(2, 6)], "drops": [{"cell": Vector2i(1, 6), "dir": L}, {"cell": Vector2i(2, 6), "dir": R}]},
			{"type": "penthouse", "cells": [Vector2i(4, 5), Vector2i(5, 5), Vector2i(6, 5), Vector2i(7, 5), Vector2i(5, 6), Vector2i(6, 6)], "drops": [{"cell": Vector2i(7, 5), "dir": R}]},
			{"type": "delivery", "label": "storage", "cells": [Vector2i(4, 0), Vector2i(5, 0), Vector2i(4, 1), Vector2i(5, 1)], "drops": [{"cell": Vector2i(5, 0), "dir": R}]},
			{"type": "apartment", "cells": [Vector2i(2, 8), Vector2i(3, 8)], "drops": [{"cell": Vector2i(3, 8), "dir": R}]},
